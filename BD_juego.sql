...
CREATE TABLE Partida (id_partida INTEGER PRIMARY KEY NOT NULL, inicio DATETIME NOT NULL, final DATETIME NOT NULL, duracion DATETIME NOT NULL, ganador VARCHAR (16) NOT NULL)ENGINE = InnoDB;
